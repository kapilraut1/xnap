...
import SettlementGraphModal from "../settlement/SettlementGraphModal";
      ...
      {loading ? (
        ...
        <>
          ...
          >
            ...
            >
              {viewSettlement == 2 && <Typography>Coming soon...</Typography>}
              {viewSettlement === 1 && (
